      ...
      <div className="w-screen h-screen bg-gray-100">
                ...
                {definitions.map((definition) => (
                  <div
                    ...
                    className={`definition ${
                      isMatched(definition.id) ? "matched" : ""
                    } ${!isMatched(definition.id) && "incorrect"}`}
                    onDragOver={(e) => e.preventDefault()}
                    onDrop={(e) => {
                      const conceptId = parseInt(
                        e.dataTransfer.getData("conceptId"),
                        10
                      );
        ...
        {currentLevel === 2 && (
          <div className="canvas-3d-container w-full h-full relative">
            ...
            <div className="absolute top-20 left-1/4 w-1/2 h-1/2 flex items-center justify-center">
              <PuzzleGame
